...
Catálogo curado de recursos para el desarrollo de software con agentes de IA. No es una
librería ni una plantilla: es un índice de referencia con enlaces y una descripción propia de
...
- **Hecho frente a valoración.** Los enlaces, los nombres y la existencia de una funcionalidad
...
- **Recursos identificados por proyecto.** Cada entrada se nombra por su proyecto o producto,
  ...
  GitHub forman parte del enlace y no se usan como nombre del recurso.
- **Un recurso, un sitio.** Cada recurso aparece exactamente una vez en su bloque. Los demás
  ficheros lo referencian, no lo repiten.

## Otros documentos

- [docs/README-anterior.md](docs/README-anterior.md) — el README que tenía este repositorio
  antes del catálogo, conservado íntegro.
